...
const VisualData = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <ellipse cx="193.5" cy="750.89" rx="57.01" ry="10.96" fill={color} />
      ...
      <polyline
        ...
        strokeWidth="7"
      />
      <circle cx="318" cy="385.41" r="28" fill={color} />
      <circle cx="448" cy="240.41" r="28" fill={color} />
      <circle cx="578" cy="313.41" r="28" fill={color} />
      <circle cx="708" cy="89.41" r="28" fill={color} />
      <circle cx="958" cy="327.41" r="28" fill={color} />
      <ellipse
        cx="233.68"
        cy="722.61"
        rx="18.68"
