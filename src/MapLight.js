...
const SvgMapLight = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="url(#MapLight_svg__a)"
        d="M297.81 766.722L0 794.699V93.611l297.81-27.977v701.088z"
      />
      <path
        fill="url(#MapLight_svg__c)"
        d="M297.81 766.722l297.811 27.977V93.611L297.81 65.634v701.088z"
      />
      <path
        fill="url(#MapLight_svg__d)"
        d="M887.591 766.722l-291.97 27.977V93.611l291.97-27.977v701.088z"
      />
      <path
        fill="#f5f5f5"
        d="M298.865 747.261L9.488 774.143V100.511l289.377-26.882v673.632z"
      />
      <path
        fill="#fff"
        d="M298.865 747.261l289.377 26.882V100.511L298.865 73.629v673.632z"
      />
      <path
        fill="#f5f5f5"
        d="M877.618 747.261l-289.376 26.882V100.511l289.376-26.882v673.632z"
      />
      <path
        fill={color}
        opacity={0.3}
      ...
      <ellipse
        ...
        rx={20.674}
        ry={21.414}
        fill="url(#MapLight_svg__e)"
      />
      <path
        d="M796.972 89.515c0 34.947-63.277 133.912-63.277 133.912s-63.277-98.965-63.277-133.912a63.277 63.277 0 11126.554 0z"
        fill={color}
      />
      ...
      <ellipse
        ...
        rx={21.287}
        ry={21.566}
        fill="url(#MapLight_svg__g)"
      />
      <path
        d="M218.219 532.277c0 34.947-63.278 133.912-63.278 133.912s-63.277-98.965-63.277-133.912a63.277 63.277 0 11126.555 0z"
        fill={color}
      />
      <circle cx={154.941} cy={527.862} r={19.13} fill="#fff" />
      <path
        d="M561.219 537.277c0 34.947-63.278 133.912-63.278 133.912s-63.277-98.965-63.277-133.912a63.277 63.277 0 11126.555 0z"
        fill={color}
      />
      <circle cx={497.941} cy={532.862} r={19.13} fill="#fff" />
      <path
        d="M809.219 497.277c0 34.947-63.278 133.912-63.278 133.912s-63.277-98.965-63.277-133.912a63.277 63.277 0 11126.555 0z"
        fill={color}
      />
      <circle cx={745.941} cy={492.862} r={19.13} fill="#fff" />
      <path
        d="M250.219 63.277c0 34.947-63.278 133.912-63.278 133.912s-63.277-98.965-63.277-133.912a63.277 63.277 0 11126.555 0z"
        fill={color}
      />
