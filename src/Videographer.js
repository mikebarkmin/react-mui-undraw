...
const Videographer = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <circle cx="608.08" cy="94.6" r="44.92" fill={color} />
      <circle cx="719.12" cy="95.85" r="43.67" fill="#464353" />
      <circle cx="719.12" cy="95.85" r="32.75" fill={color} />
      <circle cx="715.73" cy="192.68" r="5.75" fill={color} />
      <circle cx="734.02" cy="192.68" r="5.75" fill={color} opacity="0.5" />
      <path
...
Videographer.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

Videographer.defaultProps = {
  color: "primary",
  style: {}
};
