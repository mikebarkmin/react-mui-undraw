...
const MobileTesting = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M879,624h0a5.18,5.18,0,0,1,7.43,4.25l1.79,23.21-10.62,1.92L872,636.6Z"
        transform="translate(-137.91 -40.56)"
        fill="#3f3d56"
      />
      <path
        d="M507.45,468.43,344.92,550.91A11.31,11.31,0,0,0,345,571.1L695.05,746.77a42.49,42.49,0,0,0,39.93-1l147.44-83.14a11.31,11.31,0,0,0-.67-20L517.44,468.32A11.31,11.31,0,0,0,507.45,468.43Z"
        transform="translate(-137.91 -40.56)"
        fill="#3f3d56"
      />
      <path
        d="M343.83,536.56l-5.09,3.78-.4,18.1a7.52,7.52,0,0,0,4.08,6.86L698.45,748a5.3,5.3,0,0,0,7.73-4.71V717Z"
        transform="translate(-137.91 -40.56)"
        fill="#3f3d56"
      />
      <path
        d="M507.45,447.45,344.92,529.92a11.31,11.31,0,0,0,.05,20.19L695.05,725.78a42.52,42.52,0,0,0,39.93-1l147.44-83.15a11.31,11.31,0,0,0-.67-20L517.44,447.33A11.31,11.31,0,0,0,507.45,447.45Z"
        transform="translate(-137.91 -40.56)"
        fill="#e3e8f4"
      />
      <polygon
        points="403.18 421.86 224.1 512.79 531.89 666.69 716.57 572.95 403.18 421.86"
        fill="#3f3d56"
      />
      ...
      <rect
        ...
        height="36"
        rx="18"
        transform="translate(-346.67 339.96) rotate(-30)"
        fill={color}
      />
      <rect
        x="606.47"
        ...
        height="36"
        rx="18"
        transform="translate(-353.07 370.08) rotate(-30)"
        fill={color}
      />
      <rect
        x="505.47"
        ...
        height="36"
        rx="18"
        transform="translate(-337.6 311.81) rotate(-30)"
        fill={color}
      />
    </svg>
  );
...
MobileTesting.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

MobileTesting.defaultProps = {
  color: "primary",
  style: {}
};
