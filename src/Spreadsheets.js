...
const Spreadsheets = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="293.36" y="339.58" width="110" height="30" fill={color} />
      <rect x="408.36" y="487.58" width="110" height="30" fill={color} />
      <rect x="522.36" y="447.58" width="110" height="30" fill={color} />
      <rect x="522.36" y="228.58" width="110" height="30" fill={color} />
      <rect x="637.36" y="376.58" width="110" height="30" fill={color} />
      <rect x="178.36" y="117.58" width="110" height="30" fill={color} />
      <rect x="408.36" y="192.58" width="110" height="30" fill={color} />
      <rect x="178.36" y="265.58" width="110" height="30" fill={color} />
    </svg>
  );
};
