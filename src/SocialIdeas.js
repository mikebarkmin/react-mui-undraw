...
const SocialIdeas = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M790.31,172.4l-5.77,14.73v60.22H805v10.88h11.53l10.88-10.88h16.67l22.42-22.42V172.4Zm68.55,48.68L846,233.9h-20.5l-10.88,10.88V233.9h-17.3V180.08h61.5ZM846,194.81v22.4h-7.68v-22.4Zm-20.5,0v22.4h-7.68v-22.4Z"
        transform="translate(-69.31 -18.91)"
        opacity="0.2"
      />
      <path
        d="M928.21,362.86,911.76,356l22-52.95,16.45,6.83ZM945,299.27a10.36,10.36,0,1,1,13.52-5.65A10.4,10.4,0,0,1,945,299.27Zm44.78,89.17-16.41-6.82,10.71-25.77c2.55-6.14,5.7-14.07-2.72-17.57s-12.63,2.58-15.5,9.48L954.94,374l-16.43-6.83,22-52.95,15.77,6.55-3,7.22.23.1c3.92-3.25,11.11-5.41,19.11-2.08,16.64,6.91,15.15,19.14,9.24,33.38l-12.09,29.08Z"
        transform="translate(-69.31 -18.91)"
        opacity="0.2"
      />
      <path
        d="M641.6,85.86A16.36,16.36,0,1,0,658,102.21,16.33,16.33,0,0,0,641.6,85.86Zm0,27a10.63,10.63,0,1,1,10.63-10.63,10.65,10.65,0,0,1-10.63,10.63Zm20.84-27.66a3.82,3.82,0,1,1-3.82-3.82A3.81,3.81,0,0,1,662.44,85.19Zm10.83,3.87c-.24-5.11-1.41-9.64-5.15-13.37s-8.26-4.9-13.37-5.15c-5.27-.3-21.06-.3-26.32,0-5.1.24-9.62,1.41-13.37,5.14s-4.9,8.26-5.15,13.37c-.3,5.27-.3,21.06,0,26.32.24,5.11,1.41,9.64,5.15,13.37s8.26,4.9,13.37,5.15c5.27.3,21.06.3,26.32,0,5.11-.24,9.64-1.41,13.37-5.15s4.9-8.26,5.15-13.37c.3-5.27.3-21,0-26.31Zm-6.8,32a10.77,10.77,0,0,1-6.06,6.06c-4.2,1.67-14.17,1.28-18.81,1.28s-14.62.37-18.81-1.28a10.77,10.77,0,0,1-6.06-6.06c-1.67-4.2-1.28-14.17-1.28-18.81s-.37-14.62,1.28-18.81a10.77,10.77,0,0,1,6.06-6.06c4.2-1.67,14.17-1.28,18.81-1.28s14.62-.37,18.81,1.28a10.77,10.77,0,0,1,6.06,6.06c1.67,4.2,1.28,14.17,1.28,18.81S668.13,116.84,666.47,121Z"
        transform="translate(-69.31 -18.91)"
        opacity="0.2"
      />
      <path
        d="M858.54,454v58.71a3.64,3.64,0,0,1-3.64,3.64H838.08V490.75h8.57l1.28-10h-9.87v-6.36c0-2.89.8-4.85,4.94-4.85h5.27v-8.91a70.91,70.91,0,0,0-7.69-.4c-7.6,0-12.82,4.64-12.82,13.17v7.35h-8.6v10h8.6v25.56H796.18a3.65,3.65,0,0,1-3.64-3.64V454a3.65,3.65,0,0,1,3.64-3.64h58.71A3.65,3.65,0,0,1,858.54,454Z"
        transform="translate(-69.31 -18.91)"
        opacity="0.2"
      />
      <path
        d="M1023.19,196.07a10.49,10.49,0,0,0-5.44-8.95c-5.92-3.23-31.29-9.34-31.29-9.34s-25.38-6.11-32.12-5.93a10.49,10.49,0,0,0-8.91,5.49c-3.23,6-6.43,19.25-6.43,19.25s-3.2,13.29-3,20.07a10.33,10.33,0,0,0,5.46,8.83c5.92,3.23,31.29,9.34,31.29,9.34s25.38,6.11,32.12,5.93a10.33,10.33,0,0,0,8.89-5.38c3.23-6,6.43-19.25,6.43-19.25S1023.36,202.85,1023.19,196.07Zm-54.82,20.37,5.81-24.13,18.31,17.17-24.11,7Z"
        transform="translate(-69.31 -18.91)"
        opacity="0.2"
      />
    </svg>
...
SocialIdeas.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

SocialIdeas.defaultProps = {
  color: "primary",
  style: {}
};

export default SocialIdeas;
