...
const DroneDelivery = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      />
      <circle cx="647.83" cy="87.06" r="20.44" fill={color} />
      <circle cx="647.83" cy="87.06" r="13.79" fill={color} />
      <circle cx="647.83" cy="87.06" r="13.79" fill="#f5f5f5" opacity="0.2" />
      <circle cx="647.83" cy="87.06" r="9.03" fill={color} />
      ...
      <rect
        ...
        fill={color}
      />
      <ellipse cx="506.14" cy="12.41" rx="31.86" ry="4.28" fill={color} />
      <ellipse cx="565.1" cy="12.41" rx="31.86" ry="4.28" fill={color} />
      <rect
        x="752.9"
        y="16.69"
        width="15.21"
      ...
      <rect
        ...
        fill={color}
      />
      <ellipse cx="730.56" cy="12.41" rx="31.86" ry="4.28" fill={color} />
      <ellipse cx="789.51" cy="12.41" rx="31.86" ry="4.28" fill={color} />
      <ellipse
        cx="506.14"
        cy="12.41"
        rx="31.86"
...
DroneDelivery.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

DroneDelivery.defaultProps = {
  color: "primary",
  style: {}
};
