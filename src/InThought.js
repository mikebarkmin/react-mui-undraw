...
const SvgInThought = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit={10}
      />
      <circle cx={53.7} cy={76.078} r={53.7} fill={color} />
      <circle
        cx={66.297}
        cy={54.2}
        r={53.7}
...
SvgInThought.propTypes = {
  color: PropTypes.string
};
SvgInThought.defaultProps = {
  color: "primary"
};
const MemoSvgInThought = React.memo(SvgInThought);
export default MemoSvgInThought;
