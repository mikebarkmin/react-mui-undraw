...
const SvgModernProfessional = ({ color, ...props }) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <circle cx={137.032} cy={553.164} r={14.92} fill={color} opacity={0.4} />
      <circle cx={109.419} cy={560.29} r={10.466} fill={color} opacity={0.4} />
      <path
      ...
      <circle cx={538} cy={252} r={12} fill={color} />
      <path fill={color} d="M105 339h20v20h-20z" />
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <circle cx={525} cy={483} r={10} fill={color} />
      <circle cx={520} cy={570} r={10} fill={color} />
      <path
...
SvgModernProfessional.propTypes = {
  color: PropTypes.string
};
SvgModernProfessional.defaultProps = {
  color: "primary"
};
const MemoSvgModernProfessional = React.memo(SvgModernProfessional);
export default MemoSvgModernProfessional;
