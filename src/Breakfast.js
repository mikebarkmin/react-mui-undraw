...
const SvgBreakfast = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M775.723 265.704h11.77v155.95h-11.77z" />
      <path
      ...
      <circle cx={444.508} cy={241.754} r={241.754} fill={color} />
      <path
      ...
      <circle cx={549.45} cy={273.625} r={12.438} fill={color} />
      <path
        d="M558.778 274.403a9.328 9.328 0 01-18.657 0M540.121 272.848a9.328 9.328 0 0118.657 0"
        opacity={0.2}
      />
      <ellipse cx={544.785} cy={269.35} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={549.45} cy={267.795} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={549.45} cy={277.901} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={554.114} cy={271.682} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={553.336} cy={280.233} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={544.008} cy={276.346} rx={0.777} ry={1.166} fill={color} />
      <circle cx={487.262} cy={275.18} r={12.438} fill={color} />
      <path
        d="M496.59 275.957a9.328 9.328 0 01-18.656 0M477.934 274.403a9.328 9.328 0 0118.656 0"
        opacity={0.2}
      />
      <ellipse cx={482.598} cy={270.904} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={487.262} cy={269.35} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={487.262} cy={279.455} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={491.926} cy={273.236} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={491.149} cy={281.787} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={481.821} cy={277.901} rx={0.777} ry={1.166} fill={color} />
      <circle cx={515.246} cy={280.621} r={12.438} fill={color} />
      <path
        d="M524.575 281.399a9.328 9.328 0 11-18.657 0M505.918 279.844a9.328 9.328 0 1118.657 0"
        opacity={0.2}
      />
      <ellipse cx={510.582} cy={276.346} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={515.246} cy={274.791} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={515.246} cy={284.897} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={519.91} cy={278.678} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={519.133} cy={287.229} rx={0.777} ry={1.166} fill={color} />
      <ellipse cx={509.805} cy={283.342} rx={0.777} ry={1.166} fill={color} />
