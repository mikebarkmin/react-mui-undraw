...
const ActiveSupport = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="655.59" y="106.45" width="142.41" height="5.64" fill={color} />
      <rect x="655.59" y="131.84" width="214.95" height="5.64" fill={color} />
...
ActiveSupport.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

ActiveSupport.defaultProps = {
  color: "primary",
  style: {}
};
