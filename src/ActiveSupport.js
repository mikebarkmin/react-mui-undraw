...
const SvgActiveSupport = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient
          id="ActiveSupport_svg__b"
          x1={584.38}
          y1={798.34}
          x2={584.38}
          y2={714.29}
          xlinkHref="#ActiveSupport_svg__a"
        />
        <linearGradient
          id="ActiveSupport_svg__c"
          x1={760.68}
          y1={248.69}
          x2={760.68}
          y2={0}
      ...
      />
      <path
        d="M73 153.77h721.69a15.8 15.8 0 0115.8 15.8v491.9H57.24V169.58A15.8 15.8 0 0173 153.77z"
        fill="#fff"
      />
      ...
      <path
        d="M419.88 375.85h32.19a139.5 139.5 0 01139.5 139.5v101.41H280.38V515.35a139.5 139.5 0 01139.5-139.5z"
        fill={color}
      />
      <circle cx={436.28} cy={179.39} r={142.22} fill="#333" />
      <path
        d="M415.34 334.43h41.13a29 29 0 0129 29v28.26a44.34 44.34 0 01-44.34 44.34h-10.49a44.34 44.34 0 01-44.34-44.34v-28.22a29 29 0 0129-29z"
        opacity={0.1}
      />
      <path
        d="M386.3 331.53h99.22v57.3a44.34 44.34 0 01-44.34 44.34h-10.54a44.34 44.34 0 01-44.34-44.34v-57.3z"
        fill="#fdb797"
      />
      <path
        d="M386.48 345.84a142.8 142.8 0 0099.22.27v-12.18h-99.22z"
        opacity={0.1}
      />
