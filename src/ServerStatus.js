...
const ServerStatus = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M961.86,709.49s4,5.24-1.85,13.15-10.68,14.58-8.73,19.51c0,0,8.83-14.68,16-14.89S969.76,718.33,961.86,709.49Z"
        transform="translate(-72.24 -63.09)"
        fill="#fc6681"
      />
      <path
        d="M961.86,709.49a6.42,6.42,0,0,1,.81,1.65c7,8.24,10.76,15.93,4,16.12-6.28.18-13.81,11.41-15.62,14.25a5.39,5.39,0,0,0,.22.64s8.83-14.68,16-14.89S969.76,718.33,961.86,709.49Z"
        transform="translate(-72.24 -63.09)"
        opacity="0.1"
      />
      <path
        d="M969.3,716.17c0,1.84-.21,3.34-.46,3.34s-.46-1.5-.46-3.34.26-1,.51-1S969.3,714.32,969.3,716.17Z"
        transform="translate(-72.24 -63.09)"
        fill="#ffd037"
      />
      <path
        d="M971.86,718.37c-1.62.88-3,1.41-3.16,1.19s1.1-1.12,2.71-2,1-.24,1.11,0S973.48,717.49,971.86,718.37Z"
        transform="translate(-72.24 -63.09)"
        fill="#ffd037"
      />
      <path
        d="M940.7,709.49s-4,5.24,1.85,13.15,10.68,14.58,8.73,19.51c0,0-8.84-14.68-16-14.89S932.79,718.33,940.7,709.49Z"
        transform="translate(-72.24 -63.09)"
        fill="#fc6681"
      />
      <path
        d="M940.7,709.49a6.61,6.61,0,0,0-.82,1.65c-7,8.24-10.75,15.93-4,16.12,6.28.18,13.82,11.41,15.62,14.25-.06.21-.13.43-.21.64,0,0-8.84-14.68-16-14.89S932.79,718.33,940.7,709.49Z"
        transform="translate(-72.24 -63.09)"
        opacity="0.1"
      />
      <path
        d="M933.25,716.17c0,1.84.21,3.34.47,3.34s.46-1.5.46-3.34-.26-1-.52-1S933.25,714.32,933.25,716.17Z"
        transform="translate(-72.24 -63.09)"
        fill="#ffd037"
      />
      <path
        d="M930.7,718.37c1.62.88,3,1.41,3.15,1.19s-1.09-1.12-2.71-2-1-.24-1.1,0S929.08,717.49,930.7,718.37Z"
        transform="translate(-72.24 -63.09)"
        fill="#ffd037"
      />
      <path
        d="M934.53,741.47s11.2-.35,14.57-2.75,17.23-5.27,18.07-1.42,16.82,19.17,4.18,19.27-29.38-2-32.74-4S934.53,741.47,934.53,741.47Z"
        transform="translate(-72.24 -63.09)"
        fill="#a8a8a8"
      />
      <path
        d="M971.58,755.23c-12.65.1-29.38-2-32.75-4-2.56-1.56-3.59-7.17-3.93-9.76l-.37,0s.71,9,4.08,11.08,20.1,4.12,32.74,4c3.65,0,4.91-1.33,4.84-3.25C975.69,754.48,974.29,755.21,971.58,755.23Z"
        transform="translate(-72.24 -63.09)"
        opacity="0.2"
      />
      <path
