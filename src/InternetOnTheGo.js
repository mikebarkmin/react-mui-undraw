...
const SvgInternetOnTheGo = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="url(#InternetOnTheGo_svg__a)"
      />
      <path
        transform="rotate(-.08 -60275.886 206186.983)"
        fill="url(#InternetOnTheGo_svg__b)"
      ...
      <rect
        ...
        fill="url(#InternetOnTheGo_svg__c)"
      />
      <rect
        x={294.91}
        y={259.74}
