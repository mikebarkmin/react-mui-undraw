    ...
    >
      ...
      <g opacity="0.1">
        ...
        <path
          ...
          opacity="0.1"
        />
        <circle cx="925.49" cy="102.72" r="10.69" fill={color} />
        <circle cx="987.93" cy="109.58" r="10.69" fill={color} />
        <circle cx="1012.01" cy="205.64" r="10.69" fill={color} />
        <circle cx="979.51" cy="253.61" r="10.69" fill={color} />
        <circle cx="935.11" cy="353.24" r="10.69" fill={color} />
        <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
        <circle cx="836.39" cy="240.4" r="10.69" fill={color} />
      ...
      <g opacity="0.1">
        ...
        <path
          ...
          opacity="0.1"
        />
        <circle cx="48.97" cy="324.78" r="5.39" fill={color} />
        <circle cx="17.51" cy="328.24" r="5.39" fill={color} />
        <circle cx="5.39" cy="376.63" r="5.39" fill={color} />
        <circle cx="21.76" cy="400.8" r="5.39" fill={color} />
        <circle cx="44.12" cy="450.99" r="5.39" fill={color} />
        <circle cx="44.12" cy="450.99" r="5.39" opacity="0.1" />
        <circle cx="93.85" cy="394.14" r="5.39" fill={color} />
      ...
      <ellipse cx="813.11" cy="655.78" rx="32.29" ry="6.21" fill={color} />
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="148.42" cy="776.87" rx="46.49" ry="8.94" fill={color} />
