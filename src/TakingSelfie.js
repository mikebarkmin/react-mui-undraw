...
const SvgTakingSelfie = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <circle cx={684.504} cy={495.199} r={31.248} fill={color} opacity={0.4} />
      <circle cx={626.672} cy={510.123} r={21.92} fill={color} opacity={0.4} />
      ...
      <ellipse
        ...
        fill="#2f2e41"
      />
      <circle cx={378.5} cy={295.527} r={89} fill="#2f2e41" />
      <path
      ...
      <path
        ...
        fill="#9f616a"
      />
      <path fill="#2f2e41" d="M251 643.027l-15 34h155.28l-11.28-36-129 2z" />
      <path
      ...
      <path
        ...
        fill="#9f616a"
      />
      <ellipse cx={112} cy={270.027} rx={11} ry={5} fill={color} />
      <path
        d="M45 369.027H31s-31-10-31-33 9-70 37-69 2 63 2 63l16.95 6.916.05 21.084z"
        fill="#9f616a"
      />
      <ellipse cx={353.5} cy={270.527} rx={57} ry={29} fill="#2f2e41" />
