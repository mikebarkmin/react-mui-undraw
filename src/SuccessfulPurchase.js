...
const SuccessfulPurchase = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#535461"
      />
      <rect x="488.44" y="160.44" width="49.88" height="73.01" fill="#774e55" />
      <rect x="488.44" y="160.44" width="49.88" height="73.01" opacity="0.2" />
      <polygon
...
SuccessfulPurchase.defaultProps = {
  color: "primary",
  style: {}
};
