...
const Processing = ({ color, style }) => {
  ...
  return (
    <svg
      ...
      id="eb56cac1-988a-4970-8192-095cb31178d1"
      data-name="Layer 1"
    ...
    >
      ...
      <rect
        width="388"
        height="524"
        fill="url(#b5b2e68b-c285-4ac0-b26c-c5e680cf112d)"
      />
      ...
      />
      <path
        d="M471.09,240.55c.1-1.11.16-2.23.16-3.36a37.33,37.33,0,0,0-1.45-10.3l-4.35.21-2-5.48,2.81-3.07a37.72,37.72,0,0,0-8.9-10.44l-3.43,2.66-4.78-3.34.55-4.13a37.17,37.17,0,0,0-13.27-3.45L435.14,204h-5.83l-1.92-3.7a37.33,37.33,0,0,0-18.13,8.63l2,3.84-4.12,4.12-4-1.25a37.29,37.29,0,0,0-5.73,12.46l3.88,2-1,5.74-4,1.25s0,.06,0,.09a37.25,37.25,0,0,0,2.49,13.4l4.32-.59,2.46,5.28-2.53,3.3a37.76,37.76,0,0,0,9.76,9.64l3.19-3,5.05,2.92-.18,4.18a37.28,37.28,0,0,0,12.9,2.29l.63,0,.92-4.25,5.81-.51,2.24,3.52a37.32,37.32,0,0,0,12.38-5.9l-1.68-4,4.47-3.75,3.84,1.59a37.45,37.45,0,0,0,6.79-11.92l-3.68-2.32,1.51-5.63Zm-37.3,24.68a28,28,0,1,1,28-28A28.07,28.07,0,0,1,433.79,265.23Z"
        transform="translate(-159.54 -82)"
        fill={color}
      />
      <line
      ...
      />
      <rect x="106" y="266" width="300" height="71" fill={color} />
      <rect x="186" y="283" width="88" height="4" fill={color} />
      <rect x="186" y="292" width="88" height="4" opacity="0.2" />
      <rect x="186" y="307" width="172" height="4" fill="#fff" />
      <circle cx="140" cy="301" r="19" fill={color} />
      ...
      />
      <polygon
        points="537.03 512 521 672 540.03 673 564 512 537.03 512"
        fill="url(#41d3ff72-5c81-40b1-a081-9da170d960ca)"
      />
      <polygon points="538 512 526 670 538 670 555 512 538 512" fill={color} />
      <polygon
        points="865.16 506 880.92 667 862.16 667 847.08 506 865.16 506"
        fill="url(#861d31c1-c685-4668-90c5-63e7f330b62f)"
      />
      <polygon points="865 507 877 665 865 665 848 507 865 507" fill={color} />
      <polygon
        points="583.9 505 569 666 588.9 666 605 505 583.9 505"
        fill="url(#95aca10b-5f5c-4c4a-b42d-5e0345d77cda)"
      />
      <polygon points="585 505 573 663 585 663 602 505 585 505" fill={color} />
      <polygon
        points="821.69 507 837 672 818.69 672 800 507 821.69 507"
        fill="url(#447533d7-1588-4f38-833a-a610814ab16b)"
      />
      <polygon points="821 512 833 670 821 670 804 512 821 512" fill={color} />
      <rect
        x="513"
        y="503"
        width="359"
      ...
      />
      <rect x="516" y="503" width="288" height="15" fill={color} />
      <rect x="804" y="503" width="66" height="15" fill={color} />
      ...
      <polygon
        points="499.84 430.1 565.23 457.89 543.22 499.7 478.58 475.88 499.84 430.1"
        fill={color}
      />
      ...
      />
      <path
        d="M736.89,558.83s12,6,3,21-68.84,9-68.84,9,15,35.91,12,62.85H659.07S651.89,590,646,584c-7.63-7.63-1.86-22.22,13.11-19.23S736.89,558.83,736.89,558.83Z"
        transform="translate(-159.54 -82)"
        fill="#263238"
      />
      <g opacity="0.2">
        <path
          d="M675.95,588.22s10.52,1,23.39,1.17c-9.34.1-18-.38-23.22-.75Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
        <path
          d="M670.71,564.85c23.37-.45,66.18-6.56,66.18-6.56a9,9,0,0,1,.9.55C725.6,560.5,688.6,565.27,670.71,564.85Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
        <path
          d="M657.75,564.05c-10.19,1.55-13.34,13-6.88,19.45,5.92,5.92,13.11,67.57,13.11,67.57h-4.9S651.89,589.42,646,583.5C638.56,576.1,643.78,562.15,657.75,564.05Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
      </g>
      <path
        d="M686,657.59s-47.89,0-47.89,6,6,9,6,9H686Z"
        transform="translate(-159.54 -82)"
        fill="#263238"
      />
      <path
        d="M685.54,657.36V659c-8.34.06-46.25.65-46.25,6a9.13,9.13,0,0,0,2.24,5.9,9.89,9.89,0,0,1-3.88-7.53C637.65,657.36,685.54,657.36,685.54,657.36Z"
        transform="translate(-159.54 -82)"
        fill="#fff"
        opacity="0.2"
      />
      <path
        d="M760.83,558.83s12,6,3,21-68.84,9-68.84,9,15,35.91,12,62.85H683s-3-62.85-12-68.84-3-21,12-18S760.83,558.83,760.83,558.83Z"
        transform="translate(-159.54 -82)"
        fill="#263238"
      />
      <path
        d="M710,657.59s-47.89,0-47.89,6,6,9,6,9H710Z"
        transform="translate(-159.54 -82)"
        fill="#263238"
      />
      <path
        d="M720.64,484h7.28c2.87,0,4.92,7.2,7,9.22,4.66,4.59,1.56,12.63,14,36.65,11.68,22.58,15.63,20.61,19.58,28.5S698,565.9,698,565.9s3.79-15.12,3-26.21c-1.64-22.79-7.56-30.68.34-38.58C701.32,501.11,709.79,484,720.64,484Z"
        transform="translate(-159.54 -82)"
        fill="#ff5252"
      />
      <polygon
      ...
      />
      <path
        d="M702.41,436.2a24.23,24.23,0,0,1,2.45.12,23.94,23.94,0,0,0,0,47.64,24.23,24.23,0,0,1-2.45.12,23.94,23.94,0,1,1,0-47.89Z"
        transform="translate(-159.54 -82)"
        fill="#fff"
        opacity="0.2"
      />
      ...
      <rect
        ...
        width="26.16"
        height="17.98"
        transform="translate(1273.66 950.37) rotate(-180)"
        fill="#ff5252"
      />
      <g opacity="0.2">
        <path
          d="M694.66,564.85c23.37-.45,66.18-6.56,66.18-6.56a9,9,0,0,1,.9.55C749.54,560.5,712.55,565.27,694.66,564.85Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
        <path
          d="M681.75,564.06c-10.26,1.56-13.42,13.09-5.8,18.17,9,6,12,68.84,12,68.84H683s-3-62.85-12-68.84C662.32,576.42,667.72,562.14,681.75,564.06Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
        <path
          d="M699.89,588.22s10.52,1,23.39,1.17c-9.34.1-18-.38-23.22-.75Z"
          transform="translate(-159.54 -82)"
          fill="#fff"
        />
      </g>
      <path
        d="M727.91,519.92v28.63a18.28,18.28,0,0,1-19,18.28c-12.65-.49-27.24-.68-28.91,1-1.39,1.39-4.7,4.06-7.86,6.52a4.64,4.64,0,0,1-7.47-4.1c.4-4.81,1.91-9.93,6.34-11.4,3.57-1.19,10-1.91,16.38-2.34a21,21,0,0,0,19.53-21V519.92Z"
        transform="translate(-159.54 -82)"
        fill="#f8c198"
      />
      <path
        d="M664.7,570.23c.4-4.81,1.91-9.93,6.34-11.4,3.57-1.19,10-1.91,16.38-2.34a21,21,0,0,0,19.53-21V519.92h21v1.63H710.23v15.57a21,21,0,0,1-19.53,21c-6.42.43-12.82,1.15-16.38,2.34-4.43,1.48-5.95,6.6-6.34,11.4a4.62,4.62,0,0,0,1.11,3.44A4.67,4.67,0,0,1,664.7,570.23Z"
        transform="translate(-159.54 -82)"
        fill="#fff"
        opacity="0.2"
      />
      <path
        d="M710.06,657.36V659c-8.34.06-46.25.65-46.25,6a9.13,9.13,0,0,0,2.24,5.9,9.89,9.89,0,0,1-3.88-7.53C662.17,657.36,710.06,657.36,710.06,657.36Z"
        transform="translate(-159.54 -82)"
        fill="#fff"
        opacity="0.2"
      />
      <polyline
        points="233 518 233 736 618 736 618 452 629 452"
        fill="none"
        stroke={color}
        stroke-miterlimit="10"
        strokeWidth="3"
