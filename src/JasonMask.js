...
const SvgJasonMask = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M536.28 403.67a58.83 58.83 0 01-117.66 0c0-32.49 26.34-48.54 58.83-48.54s58.83 16.05 58.83 48.54z"
        opacity={0.1}
      />
      <path
        d="M529.66 403.67a52.22 52.22 0 01-104.43 0c0-28.84 23.38-41.92 52.22-41.92s52.21 13.08 52.21 41.92z"
        fill={color}
      />
      <circle cx={513.55} cy={208.68} r={10.92} fill="url(#JasonMask_svg__a)" />
      <path
        d="M630.41 403.67a58.83 58.83 0 00117.66 0c0-32.49-26.34-48.54-58.83-48.54s-58.83 16.05-58.83 48.54z"
        opacity={0.1}
      />
      <path
        d="M637 403.67a52.21 52.21 0 10104.42 0c0-28.84-23.38-41.92-52.21-41.92S637 374.83 637 403.67z"
        fill={color}
      />
