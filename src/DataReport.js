...
const DataReport = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <g opacity="0.3">
        <rect x="314.93" y="277.62" width="27.06" height="82.05" fill={color} />
      </g>
      <rect x="390.43" y="236.15" width="27.06" height="123.95" fill={color} />
      <g opacity="0.3">
        <rect x="465.94" y="318.2" width="27.06" height="42.33" fill={color} />
      </g>
      <rect x="541.44" y="194.26" width="27.06" height="165.85" fill={color} />
      <g opacity="0.3">
        <rect
          x="616.94"
          y="234.41"
      ...
      <circle cx="328.46" cy="378.43" r="6.98" fill={color} />
      <circle cx="404.4" cy="378.43" r="6.98" fill={color} />
      <circle cx="480.34" cy="378.43" r="6.98" fill={color} />
      <circle cx="556.28" cy="378.43" r="6.98" fill={color} />
      <circle cx="632.22" cy="378.43" r="6.98" fill={color} />
      <line
        x1="296.16"
        y1="623.28"
        x2="673.25"
      ...
      <rect x="314.93" y="541.23" width="27.06" height="82.05" fill={color} />
      <rect x="390.43" y="540.79" width="27.06" height="82.92" fill={color} />
      <rect x="465.94" y="581.82" width="27.06" height="42.33" fill={color} />
      <rect x="541.44" y="457.87" width="27.06" height="165.85" fill={color} />
      <rect x="719.94" y="360.02" width="27.06" height="125.26" fill={color} />
      <g opacity="0.7">
        <circle cx="328.46" cy="642.04" r="6.98" fill={color} />
      </g>
      <g opacity="0.7">
        <circle cx="404.4" cy="642.04" r="6.98" fill={color} />
      </g>
      <g opacity="0.7">
        <circle cx="480.34" cy="642.04" r="6.98" fill={color} />
      </g>
      <g opacity="0.7">
        <circle cx="556.28" cy="642.04" r="6.98" fill={color} />
      </g>
      <g opacity="0.7">
        <circle cx="632.22" cy="642.04" r="6.98" fill={color} />
      </g>
      <path
