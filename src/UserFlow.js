  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth="3"
      />
      <circle cx="377.32" cy="21.63" r="21.63" fill={color} opacity="0.1" />
      <circle cx="706.43" cy="51.49" r="21.63" fill={color} opacity="0.1" />
      <circle cx="937.58" cy="371.93" r="21.63" fill={color} opacity="0.1" />
      <circle cx="1014.95" cy="275.5" r="36.25" fill={color} opacity="0.1" />
      <circle cx="966.96" cy="451.42" r="36.25" fill={color} opacity="0.1" />
      <circle cx="36.25" cy="338.07" r="36.25" fill={color} opacity="0.1" />
      <path
