...
const SvgNewsletter = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient
          id="Newsletter_svg__b"
          x1={636.83}
          y1={740.55}
          x2={636.83}
          y2={204.8}
          xlinkHref="#Newsletter_svg__a"
        />
      </defs>
      ...
      <path
        ...
        fill="url(#Newsletter_svg__a)"
        opacity={0.5}
      />
      <path
        d="M239.38 528.85l-.74 8.13a89.47 89.47 0 004.85 38.15c1.19 3.35 2.12 6.11 2.32 7.1.64 3.22 0 26.37 0 26.37s3.86 30.23 21.87 24.44c8.1-2.6 12-10.55 13.92-18.5a46.44 46.44 0 00-2.24-27.62c-2.56-6.51-5.18-15.66-3.33-22.69 3.22-12.22 3.22-29.58 3.22-29.58z"
        fill="#5a5773"
      />
      <path
        d="M220.09 389.29s25.08 61.1 23.79 83.6-.32 4.82 0 1.93c.57-5.15 0 56-1.93 63 0 0 26.37 19.29 36.66-6.43 0 0-.64-44.37 5.14-50.16 3.18-3.18 2.87-10.84 1.93-17.09a118.45 118.45 0 01-1-27.33c.39-4.7.93-8.84 1.63-10.25 1.93-3.86 3.86-47.59-7.72-59.81z"
        fill="#605d82"
      />
      <path
      ...
      />
      <g opacity={0.1}>
        <path d="M217.6 391.92c-5.33 21.84.56 102.21.56 102.21s8.36 52.73 8.36 65c0 9.33 4.49 22.77 6.62 28.61l1.74-.31s-7.72-19.29-7.72-31.51-8.36-65-8.36-65-5.38-73.45-1.2-99zM176.36 484.47l.16.33c.05-.33.1-.68.13-1a7.11 7.11 0 01-.29.67zM218.64 387.24a9.47 9.47 0 011.45-3.09l-66.24-10.29s.39 1.25 1.06 3.48z" />
      </g>
      <path
        d="M308.19 339.13s9.65 36-19.29 41.16a3.52 3.52 0 01-1.29-.64s-16.72-32.8-3.86-45.66zM189.86 99.92s1.93 27-19.29 39.87 45 48.23 45 48.23l34.73-55.31s-14.78 1.91-23.78-23.79z"
        fill="#a1616a"
      />
      <path
      ...
      />
      <path
        d="M235.2 125.92s19.61 10 26.69 8.68 25.72 10.93 24.44 35.37l11.62 36.46a148.9 148.9 0 017 45.21s16.72 46.3 7.72 66.88l-1.93 28.3s-14.79-8.36-30.23-5.79l3.89-23.11-17.4-65.61-28.94-70.1z"
        opacity={0.1}
      />
      <path
        d="M235.2 124.65s19.61 10 26.69 8.68 25.72 10.93 24.44 35.37l11.62 36.46a148.9 148.9 0 017 45.21s16.72 46.3 7.72 66.88l-1.93 28.3s-14.79-8.36-30.23-5.79l3.86-23.15L267 251.02l-28.91-70.1z"
        fill="#67647e"
      />
      <path
      ...
      />
      <path
        d="M227.16 110.18l-36.66-9s1.91 2.16-.32 10.61c5.9 6.77 13.15 15.76 22.83 15.76a32 32 0 0019.22-6.37 57.82 57.82 0 01-5.07-11z"
        opacity={0.1}
      />
      ...
      />
      <path
        d="M262.85 187.68s7.07 36.66 3.86 50.81a47.15 47.15 0 00.84 24.92M148.56 203.11s-3.08 24.44 2.05 29.58"
        opacity={0.1}
      />
      <path d="M328.13 504.3a1.5 1.5 0 000-3 1.5 1.5 0 000 3z" />
      <path
        d="M910 415.63v-.83L637.16 205a1 1 0 00-1.19 0L363.12 414.8V740h.52v.52h546.89v-325.2z"
        transform="translate(-120 -86.08)"
        fill="url(#Newsletter_svg__b)"
        opacity={0.5}
      />
      ...
      <path
        d="M306.73 669.2s-13.26-45 2.49-78.14a71.09 71.09 0 005.75-44.6 119.57 119.57 0 00-6.31-20.93"
        fill="none"
        stroke="#535461"
        strokeMiterlimit={10}
        strokeWidth={2}
      />
      <path
        d="M318.45 504.59c0 5.52-10 21.51-10 21.51s-10-16-10-21.51a10 10 0 1120 0zM335 535.15c-3 4.63-20.08 12.63-20.08 12.63s.31-18.86 3.31-23.49A10 10 0 01335 535.15zM334.24 587.36c-4.93 2.48-23.71.77-23.71.77s9.79-16.12 14.71-18.6a10 10 0 119 17.84zM324.8 626.75c-4.44 3.28-23.24 4.76-23.24 4.76s6.92-17.54 11.36-20.82a10 10 0 0111.88 16.06zM293.91 548.84c4 3.84 22.39 7.83 22.39 7.83s-4.51-18.31-8.47-22.15a10 10 0 00-13.92 14.33zM283.45 595.05c4.93 2.48 23.71.77 23.71.77s-9.79-16.12-14.71-18.6a10 10 0 00-9 17.84zM279.45 641.35c4.44 3.28 23.24 4.76 23.24 4.76s-6.92-17.54-11.36-20.82a10 10 0 10-11.88 16.06z"
        fill={color}
      />
      <path
        fill={color}
