...
const Filter = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="25.02" y="547.31" width="187.03" height="145.2" fill={color} />
      ...
      <rect x="645.05" y="544.01" width="187.03" height="145.2" fill={color} />
      ...
      <rect x="333.59" y="543.38" width="188.38" height="146.25" fill={color} />
