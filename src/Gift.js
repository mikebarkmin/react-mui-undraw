...
const SvgGift = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M605.43 227.54l23.72-27.44a5 5 0 00-.38-6.91l-51.61-39.14-6.28 9.78 40 30.79-17 18.62z"
        fill="#fda57d"
      />
      <path
        d="M602.71 203.63l-8.3 9.1 11.53 14.31 11.89-13.72a34.67 34.67 0 01-15.12-9.69z"
        opacity={0.1}
      />
      <path
        d="M536.55 233.5l-26.85-20.18a8.16 8.16 0 01-2-10.87l40.18-44.71 8.22 8.22-27.75 34.64 16.42 16.47z"
        fill="#fda57d"
      />
      <path
      ...
      />
      <path
        d="M560.06 296.82l7.94 15.89A26.34 26.34 0 00595.28 327l96.23-13.75 32.87 41.07 24.65-24.65-53-45.45a13.37 13.37 0 00-10.36-3.12z"
        fill="#4d8af0"
      />
      <path
        d="M535.91 208.19s2.16 26.68-6.05 27.6l16.43 8.22s-.91 48.38 16.43 65.73c0 0 32-17.34 65.73-16.43s-8.22-32.86-8.22-32.86l-5.55-37.4 4.57-6.85a34.33 34.33 0 01-16-10.28c-4.57 5.71-15 13.45-24.12 13.45h-3.93c-13.53 0-27.92-2.73-39.32-10z"
        opacity={0.1}
      />
      <path
        d="M534.39 205.91s2.16 26.68-6.05 27.6l16.43 8.21s-.91 48.38 16.43 65.73c0 0 32-17.34 65.73-16.43s-8.22-32.86-8.22-32.86l-5.55-37.4 4.57-6.85a34.33 34.33 0 01-16-10.28c-4.57 5.71-15 13.45-24.12 13.45h-3.93a74.73 74.73 0 01-39.32-11.17z"
        fill="#3ad29f"
      />
      <path
        d="M556.03 198.39v9.17a17.53 17.53 0 005.13 12.39l19.51 19.51 6.5-13a16.29 16.29 0 001.72-7.29v-20.8z"
        fill="#fda57d"
      />
      <path
        d="M556.28 208.95v1a24.64 24.64 0 0032.83 0v-10.17h-32.83z"
        opacity={0.1}
      />
      <circle cx={572.46} cy={190.17} r={24.65} fill="#fda57d" />
      <path
        d="M556.03 183.22h41.08s16.43-16.43 0-24.65a56.24 56.24 0 00-11.15-3.94c-25-6.34-48.74 14.33-45.53 39.91.76 6 2.93 11 7.38 13.32 17.35 9.14 8.22-24.64 8.22-24.64z"
        opacity={0.1}
      />
      <path
        d="M556.03 182.08h41.08s16.43-16.43 0-24.65a56.24 56.24 0 00-11.15-3.94c-25-6.34-48.74 14.33-45.53 39.91.76 6 2.93 11 7.38 13.32 17.35 9.14 8.22-24.64 8.22-24.64z"
        fill="#333"
      />
