...
const SvgMediaPlayer = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      <path
        d="M411 596h-6.016a4.984 4.984 0 01-4.984-4.984V574h11l4.421 16.211A4.583 4.583 0 01411 596z"
        fill="#605d82"
      />
      <rect
        x={79.5}
      ...
      <circle
        ...
        strokeMiterlimit={10}
      />
      <rect x={505} y={63.5} width={99} height={27} rx={5.423} fill={color} />
      <rect x={646} y={63.5} width={99} height={27} rx={5.423} fill={color} />
      <rect
        x={512}
        y={55.5}
        width={99}
      ...
      />
      <path
        d="M451.903 365.09a68.198 68.198 0 10-78.523-110.185M406 285.92V274.31L446.92 305l-9.42 6.5"
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      />
      <path
        d="M409.64 243.8a68.2 68.2 0 1068.2 68.2 68.232 68.232 0 00-68.2-68.2zM396 342.69v-61.38L436.92 312 396 342.69z"
        fill={color}
      />
      <path
