...
const SvgTypewriter = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <ellipse cx={180.47} cy={642.47} rx={67.3} ry={12.94} fill={color} />
      ...
      <rect
        ...
        opacity={0.1}
      />
      <ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} fill={color} />
      <ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
      <ellipse cx={275.91} cy={458.93} rx={15.31} ry={12.81} fill={color} />
      ...
      <ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} fill={color} />
      <ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
      <ellipse cx={736.71} cy={458.93} rx={15.31} ry={12.81} fill={color} />
      <rect
        x={275.91}
        y={625.77}
        width={467.68}
      ...
      <g data-name="woman">
        ...
        />
        <path
          d="M486.25 482.54l-4.4 1.57-1.6-2.66v-.23a7.7 7.7 0 015.47-1.08z"
          opacity={0.1}
        />
        <path
