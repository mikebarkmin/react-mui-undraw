...
const Select = ({ color, style }) => {
  ...
  return (
    <svg
      ...
      id="b9a38b5d-9c66-4a75-a477-70b37749fa7e"
      data-name="Layer 1"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          xlink:href="#0b4bbb50-2c74-4271-bf06-9944ea4886f0"
        />
        <linearGradient
      ...
      <circle
        ...
        cy="406.7"
        r="56.84"
        fill="url(#53153d7b-989b-4b45-8d94-5525de3b761a)"
      />
      <circle cx="176.82" cy="406.7" r="50.52" fill={color} />
      <g opacity="0.2">
        <rect x="276.28" y="368.8" width="89.99" height="15.79" fill={color} />
        <rect x="276.28" y="398.8" width="247.87" height="15.79" fill={color} />
        <rect x="276.28" y="428.8" width="247.87" height="15.79" fill={color} />
      </g>
      <polygon
