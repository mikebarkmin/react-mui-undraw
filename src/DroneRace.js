    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          x2="404.29"
          y2="496.58"
          xlink:href="#38c5ff3f-db05-4f92-8a6f-086685ba9c9d"
        />
        <linearGradient
      ...
      />
      <circle cx="525.99" cy="432.38" r="17.76" fill={color} />
      <circle cx="525.99" cy="432.38" r="11.98" fill={color} />
      <circle cx="525.99" cy="432.38" r="11.98" fill="#f5f5f5" opacity="0.2" />
      <circle cx="525.99" cy="432.38" r="7.85" fill={color} />
      ...
      <rect
        ...
        fill={color}
      />
      <ellipse cx="402.9" cy="367.53" rx="27.67" ry="3.72" fill={color} />
      <ellipse cx="454.12" cy="367.53" rx="27.67" ry="3.72" fill={color} />
      <rect
        x="617.28"
        y="371.25"
        width="13.22"
      ...
      <rect
        ...
        fill={color}
      />
      <ellipse cx="597.86" cy="367.53" rx="27.67" ry="3.72" fill={color} />
      <ellipse cx="649.08" cy="367.53" rx="27.67" ry="3.72" fill={color} />
      <ellipse
        cx="402.9"
        cy="367.53"
        rx="27.67"
      ...
      <g opacity="0.7">
        ...
        />
        <circle cx="314.71" cy="477.51" r="11.83" fill={color} />
        <circle cx="314.71" cy="477.51" r="7.98" fill={color} />
        <circle cx="314.71" cy="477.51" r="7.98" fill="#f5f5f5" opacity="0.2" />
        <circle cx="314.71" cy="477.51" r="5.23" fill={color} />
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="232.71" cy="434.3" rx="18.44" ry="2.48" fill={color} />
        <ellipse cx="266.83" cy="434.3" rx="18.44" ry="2.48" fill={color} />
        <rect
          x="375.53"
          y="436.78"
          width="8.81"
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="362.6" cy="434.3" rx="18.44" ry="2.48" fill={color} />
        <ellipse cx="396.72" cy="434.3" rx="18.44" ry="2.48" fill={color} />
        <ellipse
          cx="232.71"
          cy="434.3"
          rx="18.44"
      ...
      <g opacity="0.5">
        ...
        />
        <circle cx="133.06" cy="344.17" r="8.1" fill={color} />
        <circle cx="133.06" cy="344.17" r="5.46" fill={color} />
        <circle cx="133.06" cy="344.17" r="5.46" fill="#f5f5f5" opacity="0.2" />
        <circle cx="133.06" cy="344.17" r="3.58" fill={color} />
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="76.91" cy="314.59" rx="12.62" ry="1.7" fill={color} />
        <ellipse cx="100.27" cy="314.59" rx="12.62" ry="1.7" fill={color} />
        <rect
          x="174.69"
          y="316.28"
          width="6.03"
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="165.84" cy="314.59" rx="12.62" ry="1.7" fill={color} />
        <ellipse cx="189.2" cy="314.59" rx="12.62" ry="1.7" fill={color} />
        <ellipse
          cx="76.91"
          cy="314.59"
          rx="12.62"
      ...
      <g opacity="0.5">
        ...
        />
        <circle cx="444.78" cy="266.1" r="4.59" fill={color} />
        <circle cx="444.78" cy="266.1" r="3.09" fill={color} />
        <circle cx="444.78" cy="266.1" r="3.09" fill="#f5f5f5" opacity="0.2" />
        <circle cx="444.78" cy="266.1" r="2.03" fill={color} />
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="413" cy="249.36" rx="7.15" ry="0.96" fill={color} />
        <ellipse cx="426.22" cy="249.36" rx="7.15" ry="0.96" fill={color} />
        <rect
          x="468.35"
          y="250.32"
          width="3.41"
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="463.33" cy="249.36" rx="7.15" ry="0.96" fill={color} />
        <ellipse cx="476.56" cy="249.36" rx="7.15" ry="0.96" fill={color} />
        <ellipse
          cx="413"
          cy="249.36"
          rx="7.15"
      ...
      <g opacity="0.3">
        ...
        />
        <circle cx="309.62" cy="221.55" r="3.66" fill={color} />
        <circle cx="309.62" cy="221.55" r="2.47" fill={color} />
        <circle cx="309.62" cy="221.55" r="2.47" fill="#f5f5f5" opacity="0.2" />
        <circle cx="309.62" cy="221.55" r="1.62" fill={color} />
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="284.29" cy="208.2" rx="5.7" ry="0.77" fill={color} />
        <ellipse cx="294.83" cy="208.2" rx="5.7" ry="0.77" fill={color} />
        <rect
          x="328.41"
          y="208.97"
          width="2.72"
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="324.41" cy="208.2" rx="5.7" ry="0.77" fill={color} />
        <ellipse cx="334.96" cy="208.2" rx="5.7" ry="0.77" fill={color} />
        <ellipse
          cx="284.29"
          cy="208.2"
          rx="5.7"
      ...
      <g opacity="0.3">
        ...
        />
        <circle cx="277.92" cy="353.42" r="6.37" fill={color} />
        <circle cx="277.92" cy="353.42" r="4.29" fill={color} />
        <circle cx="277.92" cy="353.42" r="4.29" fill="#f5f5f5" opacity="0.2" />
        <circle cx="277.92" cy="353.42" r="2.81" fill={color} />
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="233.8" cy="330.18" rx="9.92" ry="1.33" fill={color} />
        <ellipse cx="252.16" cy="330.18" rx="9.92" ry="1.33" fill={color} />
        <rect
          x="310.63"
          y="331.51"
          width="4.74"
        ...
        <rect
          ...
          fill={color}
        />
        <ellipse cx="303.67" cy="330.18" rx="9.92" ry="1.33" fill={color} />
        <ellipse cx="322.03" cy="330.18" rx="9.92" ry="1.33" fill={color} />
        <ellipse
          cx="233.8"
          cy="330.18"
          rx="9.92"
