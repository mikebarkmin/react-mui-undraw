...
const PersonalSettings = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <ellipse
        ...
        opacity="0.1"
      />
      <circle cx="70.52" cy="141.18" r="21.63" fill={color} opacity="0.1" />
      <circle cx="160.67" cy="21.63" r="21.63" fill={color} opacity="0.1" />
      <circle cx="153.34" cy="103.76" r="36.25" fill={color} opacity="0.1" />
      <rect
        x="712.17"
        y="300.75"
        width="137.83"
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="977.05" cy="659.35" rx="33.95" ry="6.53" fill={color} />
      ...
      <path
        ...
        opacity="0.1"
      />
      <ellipse cx="1043.17" cy="586.83" rx="22.83" ry="4.39" fill={color} />
