...
const HealthyHabit = ({ color, style }) => {
    ...
    >
      ...
      <g opacity="0.5">
        <path
          ...
          fill={color}
        />
        <rect x="814.68" y="268.59" width="11.05" height="36.83" fill={color} />
        <rect x="792.58" y="310.02" width="11.05" height="36.83" fill={color} />
        <rect x="838.62" y="310.02" width="11.05" height="36.83" fill={color} />
        <rect x="782.46" y="302.65" width="75.5" height="10.13" fill={color} />
      </g>
      <ellipse
        cx="473.09"
        cy="577.95"
      ...
      />
      <path
        d="M593.94,555.29l79.18,36.83s24.86-19.34,23-29.46l-92.07-22.1Z"
        transform="translate(-90 -115.91)"
        fill="#4c4c78"
      />
      <path
      ...
      />
      <path
        d="M358.23,648.28s6.45,41.43,0,45.12l-4.6-.92-.92-44.19Z"
        transform="translate(-90 -115.91)"
        fill="#fff"
        opacity="0.2"
      />
      ...
      />
      <path
        d="M442,646.44s7.37,32.23,0,43.27h-8.29V644.6Z"
        transform="translate(-90 -115.91)"
        fill="#fff"
        opacity="0.2"
      />
      ...
      />
      <path
        d="M350.87,361s35,37.75,64.45,10.13l-3.68,97.6s-47.88-58-81-53.4Z"
        transform="translate(-90 -115.91)"
        fill="#ffb9b9"
      />
      <path
      ...
      />
      <path
        d="M392.3,652s6.45,41.43,0,45.12l-4.6-.92L386.78,652Z"
        transform="translate(-90 -115.91)"
        fill="#fff"
        opacity="0.2"
      />
      ...
      />
      <path
        d="M496.34,649.2s7.37,32.23,0,43.27h-8.29V647.36Z"
        transform="translate(-90 -115.91)"
        fill="#fff"
        opacity="0.2"
      />
      ...
      <g opacity="0.5">
        ...
        />
        <path
          d="M164.45,529s-26.93,4.19-29.32,0l.6-3,28.72-.6Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M166.24,596.62s-20.94,4.79-28.12,0v-5.39h29.32Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M211.4,529.93s-26.93,4.19-29.32,0l.6-3,28.72-.6Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M213.2,597.54s-20.94,4.79-28.12,0v-5.39h29.32Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M271.28,546.6s-22.17,3.45-24.14,0l.49-2.46,23.64-.49Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M272.76,602.26s-17.24,3.94-23.15,0v-4.43h24.14Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M309.94,547.36s-22.17,3.45-24.14,0l.49-2.46,23.64-.49Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
        ...
        />
        <path
          d="M311.42,603s-17.24,3.94-23.15,0v-4.43H312.4Z"
          transform="translate(-90 -115.91)"
          fill="#fff"
          opacity="0.2"
        />
      ...
      <g opacity="0.8">
        ...
        />
        <path
          d="M199.86,711s5.25,4.13,18,0"
          transform="translate(-90 -115.91)"
          opacity="0.2"
        />
        <path
          d="M198.74,681s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z"
          transform="translate(-90 -115.91)"
          fill={color}
        />
        <path
      ...
      />
      <path
        d="M259.71,733.09s5.25,4.13,18,0"
        transform="translate(-90 -115.91)"
        opacity="0.2"
      />
      <path
        d="M258.58,703.07s9,24.4,8.26,30.78l7.13-.75s-12-21.39-9-30Z"
        transform="translate(-90 -115.91)"
        fill={color}
      />
      <path
...
HealthyHabit.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

HealthyHabit.defaultProps = {
  color: "primary",
  style: {}
};
