...
const SvgPersonalData = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="#2f2e41"
      />
      <circle cx={549.478} cy={420.465} r={2.818} fill={color} />
      <circle cx={557.932} cy={420.465} r={2.818} fill={color} />
      <circle cx={566.385} cy={420.465} r={2.818} fill={color} />
      <rect
        x={467.761}
        y={449.583}
        width={107.078}
        ...
        fill="#2f2e41"
      />
      <circle cx={549.478} cy={455.219} r={2.818} fill={color} />
      <circle cx={557.932} cy={455.219} r={2.818} fill={color} />
      <circle cx={566.385} cy={455.219} r={2.818} fill={color} />
      <rect
        x={467.761}
        y={484.336}
        width={107.078}
        ...
        fill="#2f2e41"
      />
      <circle cx={549.478} cy={489.972} r={2.818} fill={color} />
      <circle cx={557.932} cy={489.972} r={2.818} fill={color} />
      <circle cx={566.385} cy={489.972} r={2.818} fill={color} />
    </svg>
  );
};

SvgPersonalData.propTypes = {
  color: PropTypes.string
};
SvgPersonalData.defaultProps = {
  color: "primary"
};
const MemoSvgPersonalData = React.memo(SvgPersonalData);
export default MemoSvgPersonalData;
