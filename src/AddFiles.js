...
const SvgAddFiles = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} opacity={0.5} d="M84.72 343.59h142.73v10.89H84.72z" />
      ...
      />
      <path fill={color} opacity={0.5} d="M84.72 448.82h142.73v10.89H84.72z" />
      <path
        fill="#e0e0e0"
        d="M84.72 492.37h142.73v10.89H84.72zM84.72 470.59h372.56v10.89H84.72z"
      />
      <path fill={color} opacity={0.5} d="M84.72 554.06h142.73v10.89H84.72z" />
      <path
        fill="#e0e0e0"
        d="M84.72 597.6h142.73v10.89H84.72zM84.72 575.83h305.41v10.89H84.72z"
      />
      <path fill={color} d="M310 281H50V54l9-11h251v238z" />
      ...
      <circle
        ...
        cy={696.25}
        r={100.13}
        fill="url(#AddFiles_svg__b)"
        opacity={0.5}
      />
      <circle cx={627.87} cy={696.25} r={93.72} fill="#3ad29f" />
      <path
        fill="url(#AddFiles_svg__d)"
      ...
      />
      <path fill={color} d="M415 326H155V99l9-11h251v238z" />
...
SvgAddFiles.propTypes = {
  color: PropTypes.string
};
SvgAddFiles.defaultProps = {
  color: "primary"
};
const MemoSvgAddFiles = React.memo(SvgAddFiles);
export default MemoSvgAddFiles;
