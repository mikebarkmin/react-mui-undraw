...
const MissedChances = ({ color, style }) => {
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          x2="490.73"
          y2="596.16"
          xlink:href="#7231b667-12f4-4b5a-a8d7-5fbb399f1f5b"
        />
        <linearGradient
      ...
      <path
        ...
        fill={color}
      />
      <circle cx="893.14" cy="817.27" r="1.07" fill="#fff" opacity="0.25" />
      <circle cx="903.14" cy="822.22" r="1.07" fill="#fff" opacity="0.25" />
      <circle cx="908.29" cy="824.53" r="1.07" fill="#fff" opacity="0.25" />
      <circle cx="918.96" cy="828.63" r="1.07" fill="#fff" opacity="0.25" />
      <circle cx="913.53" cy="826.88" r="1.07" fill="#fff" opacity="0.25" />
      <path
      ...
      <path
        ...
        fill={color}
      />
      <circle cx="796.71" cy="785.53" r="1.07" fill="#fff" opacity="0.25" />
      <circle cx="796.18" cy="794" r="1.07" fill="#fff" opacity="0.25" />
      <path
      ...
      <circle cx="322.82" cy="373.73" r="16.7" fill={color} />
      <circle cx="322.82" cy="373.73" r="10.94" fill="#333" />
      <circle cx="322.82" cy="373.73" r="3.34" fill={color} />
      <rect
        x="354.37"
        y="342.33"
        width="13.36"
...
MissedChances.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

MissedChances.defaultProps = {
  color: "primary",
  style: {}
};

export default MissedChances;
