...
const SvgTransferMoney = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M187.06 447.805s-3.98 115.127-6.338 118.662 0-119.024 0-119.024z"
        opacity={0.1}
      />
      <path
      ...
      <path
        fill="#2f2e41"
        d="M204.145 237.243l32.35-13.36 24.895 60.287-32.35 13.359z"
      />
      <ellipse
        cx={280.75}
        cy={304.458}
