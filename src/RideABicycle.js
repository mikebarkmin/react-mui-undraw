...
const RideABicycle = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke-miterlimit="10"
      />
      <circle cx="884.13" cy="474.17" r="2.73" fill={color} />
      <circle cx="826.03" cy="464.37" r="2.73" fill={color} />
      <path
        ...
        stroke-miterlimit="10"
      />
      <circle cx="832.41" cy="493.54" r="2.73" fill={color} />
      <circle cx="875.24" cy="488.07" r="2.73" fill={color} />
      <path
      ...
      />
      <path
        d="M94.13,645.66a13.57,13.57,0,0,0-1.71,3.44C77.75,666.34,69.93,682.43,84,682.83c13.14.38,28.9,23.87,32.68,29.81a12.74,12.74,0,0,1-.45,1.35s-18.48-30.73-33.52-31.16S77.59,664.14,94.13,645.66Z"
        transform="translate(-71.15 -57.51)"
        opacity="0.1"
      />
      <path
      ...
      <circle
        ...
        stroke-miterlimit="10"
      />
      <rect x="372.19" y="425.78" width="20.81" height="180.88" fill={color} />
      <path
      ...
      <polygon
        ...
        fill={color}
      />
      <circle cx="251.34" cy="615.46" r="12.81" opacity="0.1" />
      <circle cx="249.73" cy="615.46" r="12.81" fill="#535461" />
      <circle cx="675.13" cy="614.26" r="12.81" opacity="0.1" />
      <circle cx="675.93" cy="615.86" r="12.81" fill="#535461" />
      <circle cx="448.22" cy="602.66" r="25.61" opacity="0.1" />
      <circle cx="449.83" cy="602.66" r="25.61" fill="#535461" />
      <rect
        x="521.55"
        y="653.57"
        width="13.61"
      ...
      <path
        ...
        opacity="0.05"
      />
      <rect x="422.98" y="630.49" width="60" height="19" fill={color} />
      <rect x="422.98" y="630.49" width="60" height="19" opacity="0.1" />
      <path
...
RideABicycle.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

RideABicycle.defaultProps = {
  color: "primary",
  style: {}
};

export default RideABicycle;
