...
const SvgProfessor = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path fill={color} d="M681 494.178h54v7h-54z" />
      <path
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      />
      <circle cx={304.5} cy={288.678} r={9} fill={color} />
      <circle cx={388.5} cy={288.678} r={9} fill={color} />
      <path
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
      ...
      />
      <circle cx={526.5} cy={310.678} r={9} fill={color} />
      <circle cx={720.5} cy={257.678} r={9} fill={color} />
      <circle cx={626.5} cy={292.678} r={9} fill={color} />
      <path
        fill="none"
        stroke="#3f3d56"
        strokeMiterlimit={10}
...
SvgProfessor.propTypes = {
  color: PropTypes.string
};
SvgProfessor.defaultProps = {
  color: "primary"
};
const MemoSvgProfessor = React.memo(SvgProfessor);
export default MemoSvgProfessor;
