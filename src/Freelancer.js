...
const SvgFreelancer = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity={0.1}
      />
      <circle cx={146.7} cy={161.75} r={37.33} fill={color} opacity={0.1} />
      <circle cx={146.7} cy={161.75} r={31.68} fill={color} opacity={0.1} />
      <circle cx={146.7} cy={161.75} r={2.26} fill={color} opacity={0.1} />
      <path
        fill="none"
        stroke={color}
        strokeMiterlimit={10}
