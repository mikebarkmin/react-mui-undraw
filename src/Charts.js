...
const SvgCharts = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path fill={color} d="M250 403h44v118h-44z" />
      <path fill={color} opacity={0.4} d="M250 362h44v41h-44z" />
      <path fill="#ff0" d="M323 444h44v77h-44z" />
      <path fill="#ff0" opacity={0.4} d="M323 420h44v24h-44z" />
      <path
        d="M790.5 314h-.5v218h.52a109 109 0 000-218z"
        transform="translate(-158 -144)"
        fill="url(#Charts_svg__b)"
      />
      <path
      ...
      />
      <path d="M632.5 175h-.5v208h.5a104 104 0 000-208z" fill={color} />
      <path
        d="M534.22 244.91A104.05 104.05 0 00632 383v-89.44z"
        fill="#2196f3"
      />
