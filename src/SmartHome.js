...
const SmartHome = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M691.54,167.41c-72.44-2.51-141.44-25.9-207.32-51.49S353.07,62,282.37,48.43c-45.48-8.72-97.49-10-134.13,14.43-35.27,23.46-46.66,64-52.78,101.55-4.61,28.28-7.32,58,5.3,84.51,8.77,18.37,24.34,33.82,35.11,51.42,37.45,61.26,11,136.79-29.62,196.59-19,28.06-41.13,54.82-55.82,84.69s-21.49,64.08-8.64,94.54C54.54,706.36,84.9,729,117.8,745c66.81,32.4,145.54,41.68,222.31,46.93,169.94,11.62,340.79,6.59,511.18,1.55,63.06-1.87,126.39-3.76,188.43-13.51,34.44-5.41,70-14,95-34.75,31.75-26.34,39.62-70.94,18.34-104-35.68-55.39-134.35-69.15-159.29-128.6-13.73-32.72.37-69.17,20.32-99.52,42.8-65.11,114.54-122.22,118.32-196.64,2.6-51.11-31.89-102.3-85.21-126.48-55.9-25.35-133.4-22.16-174.64,19.8C830.12,153,755.5,169.63,691.54,167.41Z"
      ...
      <rect
        ...
        opacity="0.1"
      />
      <circle cx="589.4" cy="723.18" r="18.1" fill="#fff" />
      <path
        d="M624.4,221.53A8.55,8.55,0,1,1,633,213,8.56,8.56,0,0,1,624.4,221.53Z"
        transform="translate(-35 -42.72)"
        fill="#fff"
      />
      <path
        d="M624.4,204.93a8.05,8.05,0,1,1-8,8,8.06,8.06,0,0,1,8-8m0-1a9.05,9.05,0,1,0,9.05,9,9.05,9.05,0,0,0-9.05-9Z"
        transform="translate(-35 -42.72)"
        fill="#fff"
      />
      <path
        d="M617.8,330.2V312.6H631v17.6h13.42V303.81H653l-28.6-26.4-28.59,26.4h8.57V330.2Z"
        transform="translate(-35 -42.72)"
        fill={color}
      />
      <path
        d="M476.43,412V393a4,4,0,0,0-8.07,0V412a8.25,8.25,0,1,0,8.07,0ZM471,393a1.38,1.38,0,0,1,2.75,0v4.26H471Z"
        transform="translate(-35 -42.72)"
        fill="#fff"
        stroke="#fff"
        stroke-miterlimit="10"
      ...
      <rect
        ...
        opacity="0.3"
      />
      <circle cx="623.39" cy="453.99" r="6.33" fill={color} />
      <rect x="493.28" y="452.65" width="130.72" height="2.67" fill={color} />
      <path
        d="M466.9,599.43a1.73,1.73,0,0,0,1.72,1.72h7.56a1.73,1.73,0,0,0,1.72-1.72v-1.54h-11Zm5.5-31.28c-6.85,0-12.37,5.15-12.37,11.52a11.34,11.34,0,0,0,5.28,9.5v3.73a1.71,1.71,0,0,0,1.77,1.65h10.64a1.71,1.71,0,0,0,1.77-1.65v-3.73a11.32,11.32,0,0,0,5.29-9.5C484.78,573.3,479.25,568.15,472.4,568.15Z"
        transform="translate(-35 -42.72)"
        fill="#fff"
        stroke="#fff"
        stroke-miterlimit="10"
      ...
      <rect
        ...
        opacity="0.3"
      />
      <circle cx="685.39" cy="541.93" r="6.33" fill={color} />
      <rect x="493.28" y="540.6" width="192.72" height="2.67" fill={color} />
      <path
        d="M464.15,651.85v19.24h5.5v16.5l11-22h-5.5l5.5-13.74Z"
        transform="translate(-35 -42.72)"
        fill="#fff"
        stroke="#fff"
        stroke-miterlimit="10"
      ...
      <rect
        ...
        opacity="0.3"
      />
      <circle cx="567.39" cy="627" r="6.33" fill={color} />
      <rect x="493.28" y="625.67" width="74.11" height="2.67" fill={color} />
      <ellipse cx="344.08" cy="780.54" rx="59.47" ry="11.44" fill={color} />
      <ellipse cx="343.09" cy="775.68" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="764.6" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="753.53" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="742.45" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="731.37" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="720.29" rx="6.92" ry="9.06" fill="#3f3d56" />
      <ellipse cx="343.09" cy="709.21" rx="6.92" ry="9.06" fill="#3f3d56" />
      <path
        d="M404,676.13a34.28,34.28,0,0,0,2.58-3.8l-18.2-3,19.68.15a33.27,33.27,0,0,0,.63-26.28L382.31,656.9,406.65,639a33.17,33.17,0,1,0-54.78,37.12,33.85,33.85,0,0,0-3.78,6l23.62,12.27L346.53,686a33.19,33.19,0,0,0,5.34,31.14,33.16,33.16,0,1,0,52.14,0,33.18,33.18,0,0,0,0-41Z"
        transform="translate(-35 -42.72)"
        fill={color}
      />
      <path
        d="M344.78,696.63a33,33,0,0,0,7.09,20.5,33.16,33.16,0,1,0,52.14,0C408.45,711.49,344.78,692.91,344.78,696.63Z"
        transform="translate(-35 -42.72)"
        opacity="0.1"
      />
      <ellipse cx="213.92" cy="681.25" rx="91.94" ry="17.68" fill={color} />
      <ellipse cx="215.45" cy="673.74" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="656.61" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="639.48" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="622.35" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="605.23" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="588.1" rx="10.7" ry="14.01" fill="#3f3d56" />
      <ellipse cx="215.45" cy="570.97" rx="10.7" ry="14.01" fill="#3f3d56" />
      <path
        d="M210.38,496.48a52.24,52.24,0,0,1-4-5.87L234.52,486l-30.42.23a51.41,51.41,0,0,1-1-40.63l40.82,21.17L206.3,439.09A51.28,51.28,0,1,1,291,496.48a50.9,50.9,0,0,1,5.84,9.35l-36.51,19,38.93-13.07A51.3,51.3,0,0,1,291,559.89a51.28,51.28,0,1,1-80.61,0,51.3,51.3,0,0,1,0-63.41Z"
        transform="translate(-35 -42.72)"
        fill={color}
      />
      <path
        d="M302,528.18a51.1,51.1,0,0,1-11,31.71,51.28,51.28,0,1,1-80.61,0C203.51,551.16,302,522.43,302,528.18Z"
        transform="translate(-35 -42.72)"
        opacity="0.1"
      />
      <ellipse
      ...
      />
      <path
        d="M922.91,826.23a34,34,0,0,1,1.8,4.17c1.35,4,1.55,8.19,1.74,12.36a5.83,5.83,0,0,1-.22,2.39c-.57,1.5-2.23,2.26-3.78,2.68-6.49,1.74-13.34.1-20-.5s-13.27-.16-19.7-1.61a9.62,9.62,0,0,1-2.73-1,8.47,8.47,0,0,1-3.45-4.5,5.88,5.88,0,0,1-.39-1.48c-.21-2.19,1.7-4.1,3.78-4.82s4.35-.6,6.54-.83a20.61,20.61,0,0,0,18.24-17.2c.08-.48,10.84-.2,12,.42,1.33.73,2.13,2.54,2.88,3.77C920.76,822.11,921.88,824.15,922.91,826.23Z"
        transform="translate(-35 -42.72)"
        fill="#a26565"
      />
      <path
        d="M876.38,720c-.14,21.61,6.14,42.73,13.51,63q4.38,12.06,9.29,23.91c1.94,4.68,4.13,9.88,2.05,14.5,6-2.28,12.1-3.62,18.41-2.57-2.4-4.9-2.17-10.6-2.28-16A140.3,140.3,0,0,0,915,780.79a123,123,0,0,0-10.79-31.89,24.3,24.3,0,0,1-2.09-6.72c-.82-5.14-.18-10.42.89-15.51a92.47,92.47,0,0,1,12.9-31.6l.06.64a93.27,93.27,0,0,0,1.62,9.57c1.41,6.69,3.06,13.39,2.81,20.12a108.83,108.83,0,0,0,1.32,21.33,32.43,32.43,0,0,0,2.15,8.06c.69,1.55,1.59,3,2.13,4.61a21,21,0,0,1,.84,5.7c.8,16.27,0,32.79-3.32,48.74,5.57-.44,11.14,1.17,16.12,3.67a198.54,198.54,0,0,0,8.5-35.1,116.62,116.62,0,0,0-1.3-42.46,56.42,56.42,0,0,1-1.05-14.15c.43-9.45,2.75-18.69,5.06-27.87l3.52-14q2.5-10,5-19.91c1.11-4.41,2.23-8.92,1.88-13.46a33.4,33.4,0,0,0-1.56-7.32,81.69,81.69,0,0,0-11.07-22.64c-19.27,1.08-38.77-.72-58-2.2a3.89,3.89,0,0,0-2.72.46,3.85,3.85,0,0,0-1.1,2.48l-7.23,41a103,103,0,0,0-2,17.3c0,5.8.9,11.58.68,17.37C877.9,704.81,876.42,712.19,876.38,720Z"
        transform="translate(-35 -42.72)"
        fill="#454b69"
      />
      <path
        d="M916,695.71a93.27,93.27,0,0,0,1.62,9.57c4.19-7.25,8.71-14.32,12.57-21.75,1-1.91,1.94-3.85,2.89-5.79l2.85-5.8c.53-1.09,1.06-2.18,1.54-3.29a23.77,23.77,0,0,0,1.79-5c-1.4-.26-4.86,3.52-5.9,4.51a80.64,80.64,0,0,0-6,6.64A72.81,72.81,0,0,0,921,683,39.88,39.88,0,0,0,916,695.71Z"
        transform="translate(-35 -42.72)"
        opacity="0.1"
      />
      <path
        d="M899.9,496.8s10.7,17.05,8.72,20.62,33.7-3.17,33.7-3.17-19.43-17.05-17.44-24.19S899.9,496.8,899.9,496.8Z"
        transform="translate(-35 -42.72)"
        fill="#ee8e9e"
      />
      <circle cx="874.41" cy="435.05" r="24.19" fill="#ee8e9e" />
      <path
        d="M899.54,514.68a24.56,24.56,0,0,1,10.17-8.21,36.38,36.38,0,0,1,7.23-1.78l9.65-1.7c2.36-.42,4.89-.81,7.09.16a11.62,11.62,0,0,1,3,2.21c3.35,3.11,6.6,6.52,10.81,8.32,1.15.49,2.35.85,3.5,1.34,4.71,2,8.23,6.26,10.22,11,2.1,4.94,2.16,10.31,2,15.68a27.56,27.56,0,0,1-.55,5.52,35.57,35.57,0,0,1-1.83,5.06A92.57,92.57,0,0,0,957.51,563q-3.75,14.35-6.24,29a10.87,10.87,0,0,1-1.21,4,14.36,14.36,0,0,1-3.34,3.21,20.86,20.86,0,0,0-2.79,2.77,3.62,3.62,0,0,0-.89,1.52c-.31,1.44,1,2.68,2,3.73a18.06,18.06,0,0,1,4.52,7.87,3.17,3.17,0,0,1,.72,2.17,3.8,3.8,0,0,0-.23,1.72,3.88,3.88,0,0,0,.91,1.41,5.33,5.33,0,0,1,1,4.28,67.89,67.89,0,0,1-23.68,5.54c-2,.1-4,.1-6,.34-1.42.18-2.82.47-4.24.64a45.78,45.78,0,0,1-6.2.16c-10.77-.22-21.85-.49-31.74-4.76-.93-5.07,1.08-10.24,2.34-15.24,2-8,2.5-16.19,4-24.26,1-5.51,2.5-10.94,3.35-16.49s1.05-11.3-.48-16.7c-1.35-4.78-1.76-9.66-3.16-14.43s-2.38-9.94-.8-14.66C887.31,519,893.38,514.35,899.54,514.68Z"
        transform="translate(-35 -42.72)"
        fill={color}
      />
      <path
