...
const Notes = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <g opacity="0.5">
        <circle cx="71.35" cy="100.38" r="7.6" fill={color} />
        <circle cx="71.35" cy="145.96" r="7.6" fill={color} />
        <circle cx="71.35" cy="191.53" r="7.6" fill={color} />
      </g>
      ...
      />
      <g opacity="0.5">
        <circle cx="217.85" cy="218.66" r="7.6" fill={color} />
        <circle cx="217.85" cy="264.24" r="7.6" fill={color} />
        <circle cx="217.85" cy="309.82" r="7.6" fill={color} />
      </g>
      ...
      <circle cx="364.35" cy="336.94" r="7.6" fill={color} />
      <circle cx="364.35" cy="382.52" r="7.6" fill={color} />
      <circle cx="364.35" cy="428.1" r="7.6" fill={color} />
