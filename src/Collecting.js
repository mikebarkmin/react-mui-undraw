...
const SvgCollecting = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform="translate(-233 -67.75)"
        fill="url(#Collecting_svg__az)"
        opacity={0.5}
      />
      <path fill={color} d="M381.75 343.9h35.04v19.71h-35.04z" />
      <path
        fill={color}
      ...
      />
      <path fill={color} d="M384.12 446.35h32.48v4.38h-32.48z" />
      <path
        fill="#535461"
      ...
      <path
        ...
        opacity={0.5}
      />
      <path fill={color} opacity={0.6} d="M505.38 349.18h26.65v14.99h-26.65z" />
      <path
        fill={color}
        opacity={0.6}
      ...
      <path
        ...
        opacity={0.5}
      />
      <path fill={color} opacity={0.6} d="M437.51 13.6h26.65v14.99h-26.65z" />
      <path
        fill={color}
        opacity={0.6}
      ...
      <path fill={color} d="M316.54 129.07h89.42v16.21h-89.42z" />
      ...
      <path fill={color} d="M451.66 185.98h110.83v20.09H451.66z" />
