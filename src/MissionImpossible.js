...
const MissionImpossible = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="319.02" y="527" width="297" height="13" fill={color} />
      <g opacity="0.5">
        <path
      ...
      <rect x="336.02" y="540" width="15" height="161" fill={color} />
      <rect x="586.02" y="540" width="15" height="161" fill={color} />
      <polygon
...
MissionImpossible.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

MissionImpossible.defaultProps = {
  color: "primary",
  style: {}
};
