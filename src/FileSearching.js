...
const SvgFileSearching = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path fill={color} opacity={0.7} d="M193.86 183.93h149.48v4.67H193.86z" />
      <path
        fill="#e0e0e0"
      ...
      />
      <g clipPath="url(#FileSearching_svg__e)" fill={color}>
        <path
          opacity={0.4}
