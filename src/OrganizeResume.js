...
const OrganizeResume = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      />
      <rect x="171.97" y="92.7" width="725.15" height="35.21" fill="#f6f7f9" />
      <g opacity="0.2">
        <rect x="171.97" y="92.7" width="725.15" height="35.21" fill={color} />
      </g>
      <rect
        x="171.97"
        y="127.91"
        ...
        fill="#f6f7f9"
      />
      <circle cx="189.36" cy="110.09" r="7.83" fill="#f6f7f9" />
      <circle cx="210.22" cy="110.09" r="7.83" fill="#f6f7f9" />
      <circle cx="231.09" cy="110.09" r="7.83" fill="#f6f7f9" />
      <g opacity="0.2">
        <rect
          x="197.18"
          y="179.65"
      ...
      <g opacity="0.2">
        <rect x="269.78" y="434.41" width="26.08" height="86.08" fill={color} />
        <rect
          x="320.21"
          y="372.67"
          width="26.08"
        ...
        <rect
          ...
          fill={color}
        />
        <rect x="471.5" y="390.06" width="26.08" height="130.42" fill={color} />
      </g>
      <g opacity="0.2">
        <rect
          x="665.4"
      ...
      <path
        ...
        fill={color}
      />
      <rect x="24.54" y="731.83" width="953" height="7" fill={color} />
      <rect
        x="698.23"
        y="340.83"
        width="201.97"
      ...
      />
      <rect x="701.4" y="344.73" width="195.63" height="240.41" fill={color} />
      <rect x="714.54" y="365.83" width="40" height="40" fill="#e8eaf1" />
      <rect x="734.54" y="429.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="446.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="463.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="480.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="497.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="514.83" width="142" height="8" fill="#e8eaf1" />
      <rect x="734.54" y="531.83" width="142" height="8" fill="#e8eaf1" />
      <path
      ...
      <path
        ...
        fill="#4c4c78"
      />
      <circle cx="943.23" cy="364.64" r="20.13" fill="#ffb9b9" />
      <path
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="570.91" cy="376.5" r="21.19" fill="#db8b8b" />
      <path
...
OrganizeResume.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

OrganizeResume.defaultProps = {
  color: "primary",
  style: {}
};
