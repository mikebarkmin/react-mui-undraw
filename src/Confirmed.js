...
const SvgConfirmed = ({ color, ...props }) => {
...
SvgConfirmed.propTypes = {
  color: PropTypes.string
};
SvgConfirmed.defaultProps = {
  color: "primary"
};
const MemoSvgConfirmed = React.memo(SvgConfirmed);
export default MemoSvgConfirmed;
