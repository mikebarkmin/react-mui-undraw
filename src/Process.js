...
const Process = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="774" y="263" width="130" height="6" fill={color} />
      <rect x="774" y="284" width="130" height="6" fill={color} />
      <rect x="774" y="305" width="130" height="6" fill={color} />
      <rect x="774" y="326" width="130" height="6" fill={color} />
      <rect x="774" y="347" width="130" height="6" fill={color} />
      <rect x="805" y="369" width="68" height="24" fill={color} />
      <rect x="385" y="447" width="182" height="226" fill="#3f3d56" />
      <rect x="411.29654" y="572.80611" width="130" height="6" fill={color} />
      <rect x="411.29654" y="593.80611" width="130" height="6" fill={color} />
      <rect x="411.29654" y="614.80611" width="130" height="6" fill={color} />
      <rect x="411.29654" y="635.80611" width="130" height="6" fill={color} />
      <path
