...
const SvgInnovative = ({ color, ...props }) => {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <circle cx={397} cy={273.146} r={130} fill={color} />
      <path
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <ellipse cx={368} cy={681} rx={35} ry={2} fill={color} />
      <ellipse cx={360} cy={685} rx={35} ry={2} fill={color} />
      <ellipse cx={325} cy={673} rx={19} ry={1.086} fill={color} />
      <ellipse cx={393} cy={697} rx={19} ry={1.086} fill={color} />
    </svg>
  );
};

SvgInnovative.propTypes = {
