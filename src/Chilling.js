...
const SvgChilling = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M137.91 100.29h263.31v314.37H91.4V146.79a46.51 46.51 0 0146.51-46.5z"
        fill={color}
      />
      <path
        d="M139.41 100.29h261.81v314.37H91.4V148.29a48 48 0 0148.01-48z"
        opacity={0.3}
      />
      <path
        d="M209.2 100.29h255.3v314.37H154.68V154.8a54.51 54.51 0 0154.51-54.51z"
        fill={color}
      />
      <path
      ...
      />
      <path
        d="M173.41 200.52h87.79a17 17 0 0117 17v316.82a17 17 0 01-17 17h-87.79V200.52z"
        opacity={0.1}
      />
      <path
        d="M168.35 200.52h87.79a17 17 0 0117 17v316.82a17 17 0 01-17 17h-87.79V200.52z"
        fill={color}
      />
      <path
        fill={color}
      ...
      <rect
        ...
        opacity={0.15}
      />
      <circle cx={601.43} cy={205.33} r={18.22} fill={color} />
      <circle cx={601.43} cy={205.33} r={18.22} opacity={0.3} />
      <circle cx={318.96} cy={205.33} r={18.22} fill={color} />
      ...
      <path fill={color} d="M528.94 204.21h94.27v24.81h-94.27z" />
      <circle cx={583.52} cy={192.64} r={14.88} fill={color} />
      <path
        d="M555.46 215.54l-.18-.18a2.74 2.74 0 000-4.37l.16-.2a3 3 0 010 4.74z"
        fill="#4d8af0"
      />
      <path
        d="M555.46 215.54l-.18-.18a2.74 2.74 0 000-4.37l.16-.2a3 3 0 010 4.74z"
      ...
      />
      <path
        d="M555.28 215.54a3 3 0 010-4.74l.16.2a2.74 2.74 0 000 4.37zM555.37 210.9"
        fill="#4d8af0"
      />
      <path
      ...
      />
      <path
        d="M410.5 125.62l-18.13 19.88 25.19 31.3 26-30.06a75.76 75.76 0 01-33.06-21.12z"
        opacity={0.1}
      />
      <path
      ...
      />
      <path
        d="M309.07 137.25c0 .74 0 1.47.07 2.21a53.84 53.84 0 0071.74-.06v-22.19h-71.81z"
        opacity={0.1}
      />
