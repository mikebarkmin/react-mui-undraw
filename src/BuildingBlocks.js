...
const SvgBuildingBlocks = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient
          id="BuildingBlocks_svg__b"
          x1={885.66}
          y1={728.42}
          x2={885.66}
          y2={125.42}
          xlinkHref="#BuildingBlocks_svg__a"
        />
      </defs>
      <rect
        x={160.32}
      ...
      <rect
        ...
        rx={8.84}
        ry={8.84}
        fill="url(#BuildingBlocks_svg__a)"
      />
      <rect
        x={751.16}
        y={154.58}
...
SvgBuildingBlocks.propTypes = {
  color: PropTypes.string
};
SvgBuildingBlocks.defaultProps = {
  color: "primary"
};
const MemoSvgBuildingBlocks = React.memo(SvgBuildingBlocks);
export default MemoSvgBuildingBlocks;
