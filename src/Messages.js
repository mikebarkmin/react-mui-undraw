...
const Messages = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <rect x="384" y="355.19" width="177.59" height="14.16" fill={color} />
      <rect x="384" y="383.52" width="177.59" height="14.16" fill={color} />
      <rect x="384" y="512.08" width="177.59" height="14.16" fill="#e0e0e0" />
      <rect x="384" y="540.4" width="177.59" height="14.16" fill="#eee" />
      <rect x="433.03" y="221.18" width="79.53" height="25.06" fill={color} />
