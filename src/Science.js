  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="507.53" cy="472.5" r="20.73" fill={color} opacity="0.3" />
      <circle cx="519.37" cy="389.57" r="12.83" fill={color} opacity="0.3" />
      <circle cx="490.74" cy="315.52" r="12.83" fill={color} opacity="0.3" />
      <path
        ...
        opacity="0.2"
      />
      <circle cx="480.37" cy="85.01" r="20.73" fill={color} opacity="0.3" />
      <circle cx="542.56" cy="49.47" r="15.41" fill={color} opacity="0.3" />
      <circle cx="498.14" cy="8.01" r="8.01" fill={color} opacity="0.3" />
      <path
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="198.07" cy="361.59" r="7.24" fill={color} opacity="0.3" />
      <circle cx="221.76" cy="335.92" r="4.61" fill={color} opacity="0.3" />
      <circle cx="189.51" cy="326.71" r="4.61" fill={color} opacity="0.3" />
      <path
        ...
        opacity="0.2"
      />
      <circle cx="213.09" cy="214.5" r="17.59" fill={color} opacity="0.3" />
      <circle cx="160.32" cy="184.34" r="13.08" fill={color} opacity="0.3" />
      <circle cx="198.01" cy="149.16" r="6.8" fill={color} opacity="0.3" />
      <path
      ...
      />
      <polygon
        points="870.61 703.96 869.5 717.14 873.21 716.39 872.65 702.11 870.61 703.96"
        fill="#1d2366"
      />
      <path
      ...
      />
      <polygon
        points="689.5 375.14 698.41 382.75 771.71 398.15 762.61 388.88 689.5 375.14"
        fill="#fff"
      />
      <path
      ...
      />
      <path
        d="M958.06,441.28s-13.92-2.78-9.09,1.86,4.82,8.72,10.76,8.53S958.06,441.28,958.06,441.28Z"
        transform="translate(-106.19 -56.3)"
        opacity="0.1"
      />
      <path
        d="M981.63,541.3s-6.31,4.27,5.75,14.1S981.63,541.3,981.63,541.3Z"
        transform="translate(-106.19 -56.3)"
        opacity="0.1"
      />
      <path
        d="M969.56,576.37c0,.56-2.22,20.41,6.13,25.42S969.56,576.37,969.56,576.37Z"
        transform="translate(-106.19 -56.3)"
        opacity="0.1"
      />
      <path
      ...
      />
      <path
        d="M847.59,434.53c.1-.09.19-.19.28-.28C847.78,434.34,847.69,434.44,847.59,434.53Z"
        transform="translate(-106.19 -56.3)"
        fill="#ffb0b1"
      />
      <path
      ...
      />
      <path
        d="M837.46,441.6l-8.05-25.35a2.38,2.38,0,0,1,1.54-3h0a2.36,2.36,0,0,1,3,1.54L842,440.16l-.8,5.31Z"
        transform="translate(-106.19 -56.3)"
        fill="#be8b87"
      />
      <path
      ...
      />
      <polygon
        points="731.27 385.3 735.79 383.86 735.13 388.22 734.99 389.17 733.67 387.79 731.27 385.3"
        fill="#efc8c4"
      />
      <path
