...
const SvgAbstract = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      <path
        fill="#3f3d56"
        d="M701 661h394.74v2H701zM474 429V216h244V0H0v643h718V429H474z"
      />
      <path
        opacity={0.1}
        d="M718 216V0H469v213H249V0H0v216h225v213H0v214h476V429h-2V216h244z"
      />
      <path d="M172 0A172.004 172.004 0 010 172V0z" fill={color} />
      <path
        d="M80 0A80.004 80.004 0 010 80v44A124.004 124.004 0 00124 0z"
        opacity={0.1}
      />
      <path
        fill="#d0cde1"
      ...
      <path fill={color} d="M89 234h50v50H89z" />
      <path
        d="M937.032 239.849l-16.544 43.723-59.664 20.935s-36-4-36 16c0 14.18 43 2 43 2l78.662-23.572 24.816-61.45z"
        fill="#ffb8b8"
      />
      <path fill={color} d="M635 228h234v202H635z" />
      <path
        fill="#3f3d56"
        d="M747.5 289.263l36.008 62.368L819.517 414H675.483l36.009-62.369 36.008-62.368z"
      />
      <path
        fill="#d0cde1"
...
SvgAbstract.propTypes = {
  color: PropTypes.string
};
SvgAbstract.defaultProps = {
  color: "primary"
};
const MemoSvgAbstract = React.memo(SvgAbstract);
export default MemoSvgAbstract;
