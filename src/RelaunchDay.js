...
const SvgRelaunchDay = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path fill={color} d="M583.168 309.798h44.973v24.985h-44.973z" />
      ...
      <circle cx={252.015} cy={349.213} r={3.576} fill={color} />
      <path
        fill="#e6e6e6"
      ...
      />
      <circle cx={455.34} cy={188.551} r={3.576} fill={color} />
      <path
        fill="#e6e6e6"
      ...
      <path
        ...
        fill={color}
      />
      <circle cx={606.5} cy={114.5} r={11} fill={color} />
    </svg>
  );
};

SvgRelaunchDay.propTypes = {
