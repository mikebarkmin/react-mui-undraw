  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#fff"
      />
      <rect x="162.16" y="66.61" width="216.47" height="27.06" fill={color} />
      <rect x="163.39" y="116.56" width="81.18" height="27.06" fill={color} />
      <rect x="164.62" y="166.51" width="160.08" height="27.06" fill={color} />
      <rect x="165.85" y="216.47" width="196.32" height="27.06" fill={color} />
      <rect x="167.08" y="266.42" width="103.51" height="27.06" fill={color} />
    </svg>
  );
};
