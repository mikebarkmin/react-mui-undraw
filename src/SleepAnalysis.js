...
const SleepAnalysis = ({ color, style }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity="0.1"
      />
      <rect x="528.94" y="175.15" width="277.37" height="8.95" fill="#ebecf0" />
      <rect
        x="528.94"
        y="184.1"
        width="277.37"
      ...
      <path
        ...
        fill={color}
      />
      <circle cx="756.76" cy="241.91" r="6.88" fill={color} />
...
SleepAnalysis.propTypes = {
  color: PropTypes.string,
  style: PropTypes.object
};

SleepAnalysis.defaultProps = {
  color: "primary",
  style: {}
};
