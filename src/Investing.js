...
const SvgInvesting = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        opacity={0.2}
      />
      <rect x={159} y={413} width={60} height={158} rx={11.851} fill={color} />
      <rect x={273} y={318} width={60} height={253} rx={11.851} fill={color} />
      <rect x={387} y={252} width={60} height={319} rx={11.851} fill={color} />
      <rect x={501} y={189} width={60} height={382} rx={11.851} fill={color} />
      <rect x={615} y={79} width={60} height={492} rx={11.851} fill={color} />
      <rect
        x={167}
        y={405}
        width={60}
...
SvgInvesting.propTypes = {
  color: PropTypes.string
};
SvgInvesting.defaultProps = {
  color: "primary"
};
const MemoSvgInvesting = React.memo(SvgInvesting);
export default MemoSvgInvesting;
